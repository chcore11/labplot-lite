...
- `sample_01_temp_c_to_k.xlsx`：荧光发射光谱，多曲线对比。
- `sample_02_voltage_scale.xlsx`：反应动力学衰减，多组时间序列。
- `sample_03_abs_error.xlsx`：标准曲线与残差，一次线性拟合。
- `sample_04_invalid_log.xlsx`：拉曼谱峰对比，多样品叠图。
